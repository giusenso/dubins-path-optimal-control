%% DUBINS PATH - Example 5
%	author:	Giuseppe Sensolini Arra'
%   date:	August 2020
%   brief:	CS singular path, computation of the switching function
...
text(path_seg{1}.MotionLengths(1)-0.18, .5, '$t_1$','Interpreter','latex','FontSize',14);
text(sum(path_seg{1}.MotionLengths(1:3))-0.18, .5, '$t_f$','Interpreter','latex','FontSize',14);
