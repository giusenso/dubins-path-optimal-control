%% DUBINS PATH - Example 6
%	author:	Giuseppe Sensolini Arra'
%   date:	August 2020
%   brief:	C nonsingular normal optimal path, 
...
text(sum(path_seg{1}.MotionLengths(1:3))-0.3, 1.25, '$t_f$','Interpreter','latex','FontSize',14);
