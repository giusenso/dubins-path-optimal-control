...
x_len = 0.8;
y_len = (x_len/5)*4
axis([-0.8,0.8, y0-y_len,y0+y_len]);
...
text(path_seg{1}.MotionLengths(1)-0.15, .45, '$t_1$','Interpreter','latex','FontSize',14);
text(sum(path_seg{1}.MotionLengths(1:2))-0.15, .45, '$t_2$','Interpreter','latex','FontSize',14);
text(sum(path_seg{1}.MotionLengths(1:3))-0.15, .45, '$t_f$','Interpreter','latex','FontSize',14);
